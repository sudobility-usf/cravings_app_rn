...
React Native mobile application for the Cravings project.

**Package**: `cravings_app_rn` (private)
...
Custom `NetworkClient` implementation (fetch-based) — does not use the web DI layer. Configured via `ApiContext` which provides the cravings_client and QueryClient.
...
- **cravings_client** — API client SDK
- **cravings_lib** — Business logic library with `useHistoriesManager`
- **cravings_api** — Backend server this app communicates with
- **cravings_app** — Web counterpart of this mobile app; shares cravings_client, cravings_lib, and cravings_types
